...
export const BACKLOG: BacklogEntry[] = [
    ...
    { id: "bl-002", query: "how to sign a pdf on your phone", intent: "signing", volume: "high", used: true, usedInRun: "manual-2026-W34" },
    ...
    { id: "bl-005", query: "why can't i type in this pdf", intent: "troubleshooting", volume: "high", used: true, usedInRun: "manual-2026-W35" },
    { id: "bl-006", query: "how to remove a page from a pdf without adobe", intent: "page-management", volume: "high", used: false },
    { id: "bl-007", query: "how to reorder pages in a pdf", intent: "page-management", volume: "high", used: true, usedInRun: "manual-2026-W35" },
    { id: "bl-008", query: "how to rotate a pdf and save it", intent: "page-management", volume: "high", used: false },
    { id: "bl-009", query: "how to black out text in a pdf", intent: "redaction", volume: "high", used: true, usedInRun: "manual-2026-W34" },
    ...
    { id: "bl-020", query: "the things people pay acrobat for", intent: "comparison", volume: "medium", used: true, usedInRun: "manual-2026-W35" },
